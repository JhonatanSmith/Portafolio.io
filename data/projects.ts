...
export const projects: Project[] = [
  {
    ...
    description:
      "A practical tool centered on web data collection and price comparison logic, framed as a lightweight application with clear utility and an engineering-first implementation style. Mere fun project, i needed to do some exchange stuff to do gaming like... more hardcore c:",
    category: "Automation",
